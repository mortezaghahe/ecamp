...
define(["require", "exports", "../chartCommandBase"], function (require, exports, chartCommandBase_1) {
    ...
    exports.ResetDragPositionCommand = void 0;
    let ResetDragPositionCommand = class ResetDragPositionCommand extends chartCommandBase_1.ChartCommandBase {
        onExecuteChartCommand(sender, args) {
            this.chartViewChartManager.resetPanningCoords();
        }
    };
    ResetDragPositionCommand = __decorate([
        mco.role()
    ], ResetDragPositionCommand);
