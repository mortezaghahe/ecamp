...
define(["require", "exports", "./calculatorBase", "../calculationDataPoints", "../calculationDataNumberOrPoints", "../../point", "../calculationDataDisplayInfo", "./calculatorHelper"], function (require, exports, calculatorBase_1, calculationDataPoints_1, calculationDataNumberOrPoints_1, point_1, calculationDataDisplayInfo_1, calculatorHelper_1) {
    ...
    exports.GreaterThanCalculator = void 0;
    let GreaterThanCalculator = class GreaterThanCalculator extends calculatorBase_1.CalculatorBase {
        constructor() {
            super("greater than", "Greater than a > b", "Applies greater than comparison: input a > input b");
            ...
            this.outputValue = "greater than";
        }
        getDefaultInputData() {
            let defaultInputData = super.getDefaultInputData();
            defaultInputData.push(new calculationDataNumberOrPoints_1.CalculationDataNumberOrPoints(this.inputId1, this.inputName1, 0, "Input is a signal: Each Y value of the signal is used for greater than comparison; Input is a constant: Constant used for greater than comparison", new calculationDataDisplayInfo_1.CalculationDataDisplayInfo(false, true)));
            defaultInputData.push(new calculationDataNumberOrPoints_1.CalculationDataNumberOrPoints(this.inputId2, this.inputName2, 0, "Input is a signal: Each Y value of the signal is used for greater than comparison; Input is a constant: Constant used for greater than comparison", new calculationDataDisplayInfo_1.CalculationDataDisplayInfo(false, true)));
        ...
        executeAlgorithm() {
            ...
            if (calculatorHelper_1.CalculatorHelper.calculationInputDataIsSignal(inputData1.data) && calculatorHelper_1.CalculatorHelper.calculationInputDataIsNumber(inputData2.data)) {
                result = this.calcSignalGreaterThanConstant(inputData1.data, inputData2.data);
            }
            ...
            if (calculatorHelper_1.CalculatorHelper.calculationInputDataIsNumber(inputData1.data) && calculatorHelper_1.CalculatorHelper.calculationInputDataIsSignal(inputData2.data)) {
                result = this.calcConstantGreaterThanSignal(inputData1.data, inputData2.data);
            }
            ...
            if (calculatorHelper_1.CalculatorHelper.calculationInputDataIsSignal(inputData1.data) && calculatorHelper_1.CalculatorHelper.calculationInputDataIsSignal(inputData2.data)) {
                result = this.calcSignalGreaterThanSignal(inputData1.data, inputData2.data);
            }
        ...
        /**
         * Calculate "greater than" comparison with each Y-IPoint-Array value and the given number
         ...
         * @memberof GreaterThanCalculator
         */
        calcSignalGreaterThanConstant(inputSignal, inputNumber) {
            let result = new Array();
        ...
        /**
         * Calculate "greater than" comparison with the given number and each Y-IPoint-Array value
         ...
         * @memberof GreaterThanCalculator
         */
        calcConstantGreaterThanSignal(inputNumber, inputSignal) {
            let result = new Array();
            for (let i = 0; i < inputSignal.length; i++) {
        ...
        /**
         * Applies "greater than" comparision between two Y-IPoint-Array values
         *
         * @private
         ...
         * @memberof GreaterThanCalculator
         */
        calcSignalGreaterThanSignal(inputSignal1, inputSignal2) {
            let result = new Array();
    ...
    GreaterThanCalculator = __decorate([
        mco.role()
    ], GreaterThanCalculator);
    exports.GreaterThanCalculator = GreaterThanCalculator;
});
