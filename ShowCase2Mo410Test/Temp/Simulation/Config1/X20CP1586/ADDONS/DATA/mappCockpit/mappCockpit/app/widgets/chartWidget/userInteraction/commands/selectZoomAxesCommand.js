...
define(["require", "exports", "../chartCommandBase"], function (require, exports, chartCommandBase_1) {
    ...
    exports.SelectZoomAxesCommand = void 0;
    let SelectZoomAxesCommand = class SelectZoomAxesCommand extends chartCommandBase_1.ChartCommandBase {
        onExecuteChartCommand(sender, args) {
            this.chartViewChartManager.setChartZoomAxes(args.data.zoomAxes);
        }
    };
    SelectZoomAxesCommand = __decorate([
        mco.role()
    ], SelectZoomAxesCommand);
