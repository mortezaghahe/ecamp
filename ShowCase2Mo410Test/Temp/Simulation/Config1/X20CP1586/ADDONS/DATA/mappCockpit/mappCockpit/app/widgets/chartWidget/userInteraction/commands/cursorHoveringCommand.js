...
define(["require", "exports", "../chartCommandBase"], function (require, exports, chartCommandBase_1) {
    ...
    exports.CheckCursorHoveringCommand = void 0;
    let CheckCursorHoveringCommand = class CheckCursorHoveringCommand extends chartCommandBase_1.ChartCommandBase {
    ...
    CheckCursorHoveringCommand = __decorate([
        mco.role()
    ], CheckCursorHoveringCommand);
