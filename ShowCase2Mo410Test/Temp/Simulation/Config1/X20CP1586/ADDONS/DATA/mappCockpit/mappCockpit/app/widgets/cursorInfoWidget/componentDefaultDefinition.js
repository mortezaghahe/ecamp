...
define(["require", "exports", "../../common/componentBase/componentSettings", "../common/componentDefaultDefinitionWidgetBase", "../traceViewWidget/bindingIds"], function (require, exports, componentSettings_1, componentDefaultDefinitionWidgetBase_1, bindingIds_1) {
    ...
    let ComponentDefaultDefinition = ComponentDefaultDefinition_1 = class ComponentDefaultDefinition extends componentDefaultDefinitionWidgetBase_1.ComponentDefaultDefinitionWidgetBase {
        constructor() {
            super(...arguments);
            this.defaultComponentSettingsId = "CursorInfoWidgetDefinition";
        }
        /**
        ...
        getDefaultComponentSettings() {
            ...
            componentSettings.addSubComponent("CursorSignalsDataModel", ComponentDefaultDefinition_1.CursorSignalsDataModelId);
            // Add bindings
