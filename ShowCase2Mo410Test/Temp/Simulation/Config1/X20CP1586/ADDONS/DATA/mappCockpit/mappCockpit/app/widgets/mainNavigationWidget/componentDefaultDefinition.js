...
define(["require", "exports", "../../common/componentBase/componentSettings", "../common/componentDefaultDefinitionWidgetBase"], function (require, exports, componentSettings_1, componentDefaultDefinitionWidgetBase_1) {
    ...
    let ComponentDefaultDefinition = ComponentDefaultDefinition_1 = class ComponentDefaultDefinition extends componentDefaultDefinitionWidgetBase_1.ComponentDefaultDefinitionWidgetBase {
        constructor() {
            super(...arguments);
            this.defaultComponentSettingsId = "mainNavigationWidgetDefinition";
        }
        /**
        ...
        getDefaultComponentSettings() {
            ...
            componentSettings.addSubComponent("SideBarWidget", ComponentDefaultDefinition_1.SideBarWidgetId);
            componentSettings.addSubComponent("TopBarWidget", ComponentDefaultDefinition_1.TopBarWidgetId);
            componentSettings.addSubComponent("MainContentWidget", ComponentDefaultDefinition_1.MainContentWidgetId);
            return componentSettings;
        }
    };
    ComponentDefaultDefinition.SideBarWidgetId = "SideBarWidget";
    ComponentDefaultDefinition.TopBarWidgetId = "TopBarWidget";
    ComponentDefaultDefinition.MainContentWidgetId = "MainContentWidget";
