...
define(["require", "exports", "../chartCommandBase"], function (require, exports, chartCommandBase_1) {
    ...
    exports.SetCursorOnPointerPositionCommand = void 0;
    let SetCursorOnPointerPositionCommand = class SetCursorOnPointerPositionCommand extends chartCommandBase_1.ChartCommandBase {
    ...
    SetCursorOnPointerPositionCommand = __decorate([
        mco.role()
    ], SetCursorOnPointerPositionCommand);
