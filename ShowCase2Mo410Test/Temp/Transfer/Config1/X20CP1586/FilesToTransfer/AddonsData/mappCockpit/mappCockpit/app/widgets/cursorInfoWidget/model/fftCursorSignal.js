...
define(["require", "exports", "../../../common/math/sum", "../../../common/math/mean", "../../../common/math/standardDeviation", "../../../common/math/variance", "../../../common/math/min", "../../../common/math/max", "../../../common/math/rms", "./cursorSignal", "./fftCursorSignalDescriptor"], function (require, exports, sum_1, mean_1, standardDeviation_1, variance_1, min_1, max_1, rms_1, cursorSignal_1, fftCursorSignalDescriptor_1) {
    ...
    exports.FFTCursorSignal = void 0;
    let FFTCursorSignal = class FFTCursorSignal extends cursorSignal_1.CursorSignal {
        /**
        ...
        constructor(serie, expandState, cursorInfo) {
            ...
            this._cursorSignalDescriptor = new fftCursorSignalDescriptor_1.FFTCursorSignalDescriptor(cursorInfo);
        }
        /**
    ...
    let InfoValues = InfoValues_1 = class InfoValues {
        constructor() {
            ...
            this.f1 = InfoValues_1.undefinedText;
            this.f2 = InfoValues_1.undefinedText;
            this.yDiff = InfoValues_1.undefinedText;
            this.fDiff = InfoValues_1.undefinedText;
