...
define(["require", "exports", "../chartCommandBase"], function (require, exports, chartCommandBase_1) {
    ...
    exports.ToogleBoxZoomCommand = void 0;
    let ToogleBoxZoomCommand = class ToogleBoxZoomCommand extends chartCommandBase_1.ChartCommandBase {
        onExecuteChartCommand(sender, args) {
            this.chartViewChartManager.setBoxZoom(args.data.boxZoomEnabled);
        }
    };
    ToogleBoxZoomCommand = __decorate([
        mco.role()
    ], ToogleBoxZoomCommand);
