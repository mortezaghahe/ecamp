...
define(["require", "exports", "../chartCommandBase"], function (require, exports, chartCommandBase_1) {
    ...
    exports.SelectPanningAxesCommand = void 0;
    let SelectPanningAxesCommand = class SelectPanningAxesCommand extends chartCommandBase_1.ChartCommandBase {
        onExecuteChartCommand(sender, args) {
            this.chartViewChartManager.setPanningAxes([args.data.zoomAxes]);
        }
    };
    SelectPanningAxesCommand = __decorate([
        mco.role()
    ], SelectPanningAxesCommand);
