...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  <TaskClass Name="Cyclic#1">
    <Task Name="BoxLift" Source="BoxLift.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="ComTCP_P" Source="Libraries.ComTCP.ComTCP_P.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
    <Task Name="AlarmBlink" Source="AlarmBlink.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Axis1ST" Source="Axis1ST.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
  <TaskClass Name="Cyclic#2" />
  <TaskClass Name="Cyclic#3" />
  <TaskClass Name="Cyclic#4">
    <Task Name="RecipeMgmt" Source="RecipeMgmt.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="PowerON" Source="PowerON.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="CamAutomat" Source="CamAutomat.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="LDMPAccess" Source="LDMPAccess.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
